...
class OccurrencesControllerTest < ActionController::TestCase
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post :create, occurrence: { date: @occurrence.date, description: @occurrence.description, location: @occurrence.location, stars: @occurrence.stars }
    end
  ...
  test "should update occurrence" do
    patch :update, id: @occurrence, occurrence: { date: @occurrence.date, description: @occurrence.description, location: @occurrence.location, stars: @occurrence.stars }
    assert_redirected_to occurrence_path(assigns(:occurrence))
  end
